...
// --------------------------- CONSTRUCTORS ---------------------------
     ...
     * need to call release in order to properly finalize it.
     *
     * @param config The configuration object
     * @throws IOException thrown if audio recorder can not be created for some reason.
     */
    SpeechRecognizer(Config config) throws IOException {
...
// -------------------------- OTHER METHODS --------------------------
     ...
     */
    public void addAllphoneSearch(String name, File phonetic) {
        decoder.setAllphoneFile(name, phonetic.getPath());
    }
     ...
     *               </code>
     */
    public void addKeywordSearch(String name, File phrase) {
        decoder.setKws(name, phrase.getPath());
    }
     ...
     *
     * @param timeout in milliseconds to listen.
     * @return true if recognition was actually started
     */
