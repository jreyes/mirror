package com.vaporwarecorp.mirror.component.draggable;
...
import com.vaporwarecorp.mirror.component.draggable.transformer.Transformer;
import com.vaporwarecorp.mirror.component.draggable.transformer.TransformerFactory;
...
// -------------------------- OTHER METHODS --------------------------
    ...
    private void initializeAttributes(AttributeSet attrs) {
        ...
        this.marginRight = attributes.getDimensionPixelSize(R.styleable.draggable_view_top_view_margin_right,
                DEFAULT_TOP_VIEW_MARGIN);
        this.dragViewId = generateViewId();
        attributes.recycle();
    }
    ...
    void attachTopFragment(Fragment topFragment) {
        addFragmentToView(dragViewId, topFragment);
    }
